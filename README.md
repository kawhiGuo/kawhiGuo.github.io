...
##2019.03.01
今天去面试晓教育，主要业务线是pc端的教育培训，聊了一下涉及在线富文本编辑和在线word编写，技术栈angular。

笔试题：
this的指向，闭包， 输入li的下标，数组去重，找出出现最多的字符和次数。

a && func（）的值是当a为true时候，返回func（）的值。

面试：
最好的一个项目，性能优化，vue生命周期，vue源码。
总结：技术官挺厉害，给了一些技术建议。

## 2019.03.04
经过一周面试，收到了五个offer，感谢所有认可我的公司和人事。
今天决定了周四入职南方电网，需要更加努力。
